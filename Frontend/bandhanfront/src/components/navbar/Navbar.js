        ...
        <Box sx={{flexGrow:1}}>
            <AppBar position="static" color="secondary">
                 <Toolbar>
                    ...
                    {access_token? <Button component={NavLink} to='/UserProfile' style={({isActive})=>{return{backgroundColor:isActive ? '#6d1b7b' :''}}} sx={{color:'white', textTransform:'none'}}>Profile</Button> : <Button component={NavLink} to='/login' style={({isActive})=>{return{backgroundColor:isActive ? '#6d1b7b' :''}}} sx={{color:'white', textTransform:'none'}}>Login</Button>}
                 </Toolbar>           
            </AppBar>
        </Box>
    </>;

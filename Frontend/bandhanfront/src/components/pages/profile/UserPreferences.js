...
const UserPreferences = () => {
    ...
    return <>
        <CssBaseline />
        <Typography variant="h6" sx={{ color: '#6d1b7b', mt:2 }}>Create Profile - Your Preferrences for the Partner</Typography>
       
        <Grid container component='form' noValidate  sx={{height:'82vh', backgroundColor:'white', padding:'1px', paddingTop:'1px',width: "100%" }} id='userpreference-form' onSubmit={handleSubmit}>
          ...
          <Box xs={12} sx={{margin: "auto"}}>
            <Button xs={12} sx={{backgroundColor:'#6d1b7b', mt:1}} type='submit' variant='contained' >Save Preferences</Button>
           </Box>
